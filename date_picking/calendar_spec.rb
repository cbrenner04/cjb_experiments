...
def wrong_day_30(num)
  if two_30_one_31_last
    calendar_date(num, 1)
  elsif two_30_one_31_not_last || two_30_two_31
    calendar_date(num, 2)
  end
end
...
def unusual_day_4(num)
  if one_30_last
    calendar_date(num, 1)
  elsif one_30_not_last || two_30_one_31_last
    calendar_date(num, 3)
  elsif two_30_one_31_not_last || two_30_two_31
    calendar_date(num, 4)
  end
